...
class App(QtWidgets.QMainWindow):
    ...
    def update_all_graphs(self):
        ...
        try:
            g1 = cov1.get_group(self.country)
        ...
        g2 = cov2.get_group(self.country)
    ...
    def on_button_click(self):
        ...
        try:
            g1 = cov1.get_group(self.country)
            pd.concat([g1, g2]).to_csv(os.getcwd()+'\\out\\{}.csv'.format(self.country), index=False, header=True)
        except KeyError as e:
            g2.to_csv(os.getcwd()+'\\out\\{}.csv'.format(self.country), index=False, header=True)
